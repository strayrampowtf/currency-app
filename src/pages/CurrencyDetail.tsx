...
// Импортируем ТОЛЬКО Currency (базовый тип), потому что детали не используют change24h
...
interface CurrencyDetailModalProps {
  // Принимаем базовый тип Currency — он включает всё нужное: charCode, name, rate
  currency: Currency;
}
